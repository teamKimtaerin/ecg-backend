...
class ProjectService:
    ...
    async def create_or_update_project(
        ...
        if existing_project:
            ...
            # 프로젝트 업데이트
            return await ProjectService._update_project(db, existing_project, project_data)
        else:
            # 새 프로젝트 생성
    ...
    async def _create_project(
        ...
        try:
            ...
            new_project = Project(
                ...
                video_metadata=project_data.video_metadata.model_dump() if project_data.video_metadata else None,
                version=1,
                change_count=0,
