...
def test_animation_requests():
    ...
    print("💡 실제 AWS 연결 시 langchain_bedrock_service.create_subtitle_animation_chain() 메서드로 테스트 가능합니다.")
...
def test_animation_categories():
    ...
    animation_categories = {
        "rotation": {
            ...
            "parameters": ["rotationDegrees", "animationDuration", "axisX", "axisY", "axisZ", "perspective", "staggerDelay"]
        },
        "fadein": {
            "description": "페이드 인 효과",
            "keywords": ["페이드", "서서히", "fade", "투명", "나타나"],
            "parameters": ["staggerDelay", "animationDuration", "startOpacity", "scaleStart", "ease"]
        },
        "typewriter": {
            "description": "타이핑 효과",
            "keywords": ["타이핑", "타자", "typewriter", "커서", "글자씩"],
            "parameters": ["typingSpeed", "cursorBlink", "cursorChar", "showCursor", "soundEffect"]
        },
        "glow": {
            "description": "글로우 효과",
        ...
        "scalepop": {
            ...
            "parameters": ["popScale", "animationDuration", "staggerDelay", "bounceStrength", "colorPop"]
        },
        "slideup": {
            "description": "슬라이드 업 효과",
            "keywords": ["슬라이드", "올라", "slide", "위로", "아래서"],
            "parameters": ["slideDistance", "animationDuration", "staggerDelay", "easeType", "blurEffect"]
        },
        "elastic": {
            "description": "탄성 효과",
            "keywords": ["탄성", "바운스", "elastic", "튕기", "반동"],
            "parameters": ["bounceStrength", "animationDuration", "staggerDelay", "startScale", "overshoot"]
        },
        "glitch": {
            "description": "글리치 효과",
            "keywords": ["글리치", "glitch", "오류", "깜빡", "노이즈"],
            "parameters": ["glitchIntensity", "animationDuration", "glitchFrequency", "colorSeparation", "noiseEffect"]
        },
        "flames": {
            "description": "불꽃 효과",
